...
$(document).on("pageshow", "#flikr", function() {
	$(function() {
		$.getJSON("http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=08388e6665cb979637d57eccb95938d8&tags=protools%2C+pro+tools&per_page=12&page=1&format=json&nojsoncallback=1",
			function(flikrd) {
				console.log(flikrd);
				if (flikrd.stat != "ok"){
